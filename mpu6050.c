...
void MPU6050_Config(MPU_ConfigTypeDef *config)
{
	...
	i2c_write_byte(MPU_ADDR, PWR_MAGT_1_REG, 0x80);
	...
	i2c_write_byte(MPU_ADDR,PWR_MAGT_1_REG, Buffer);
	...
	i2c_write_byte(MPU_ADDR,CONFIG_REG, Buffer);
	...
	i2c_write_byte(MPU_ADDR,GYRO_CONFIG_REG, Buffer);
	...
	i2c_write_byte(MPU_ADDR,ACCEL_CONFIG_REG, Buffer);
...
{
    i2c_write_byte(MPU_ADDR, SMPLRT_DIV_REG, SMPRTvalue);
}
